...
interface VotingEscrow {
    ...
    function checkpoints(address, uint32) external view returns (uint256 timestamp);
    ...
    function point_history(uint256) external view returns (int128 bias, int128 slope, uint256 ts, uint256 blk);
